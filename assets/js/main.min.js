! function(e) {
    ...
    var t = {
        ...
        menuInit: function() {
            e(".menu:not(.menu-vertical)").superfish({ popUpSelector: "ul, .megamenu", hoverClass: "show", delay: 0, speed: 80, speedOut: 80, autoArrows: !0 }), e(".menu.menu-vertical").superfish({ popUpSelector: "ul, .megamenu", hoverClass: "show", delay: 0, speed: 200, speedOut: 200, autoArrows: !0, animation: { left: "100%", opacity: "show" }, animationOut: { left: "90%", opacity: "hide" } });
            var t = function() {
        ...
        stickyHeader: function() {
            var t = !1,
                ...
                o = null,
                n = function(t, i) {
                    t.hasClass("fixed") && (t.removeClass("fixed"), t.css("top", ""), i.changes && i.changes.forEach(function(e) { e.removeClass && t.find(e.item).addClass(e.removeClass), e.addClass && t.find(e.item).removeClass(e.addClass) }), i.move && i.move.forEach(function(i) {
                        if (i.clone) t.find(i.item).hide();
                        else {
                            var o = 0;
                            t.find(i.item).each(function() { e('.sticky-placeholder[data-sticky-placeholder="' + (i.indexStart + ++o) + '"]').replaceWith(e(this)) })
                        }
                    }), t.parent().css("min-height", ""))
                },
                s = function() {
                    if (992 > e(window).width()) t && i.each(function(t) { n(e(this), o[t]) });
                    else {
                        t || function() {
                            var n = 0;
                            o = [], i = e(".sticky-header").each(function() {
                                var t = e(this),
                                    ...
                                    s = {};
                                i && (s = JSON.parse(i.replace(/'/g, '"').replace(";", ""))), s.move && s.move.forEach(function(t) { t.clone || (t.indexStart = n, n += e(t.item).length) }), s.height = t.outerHeight(), s.offset = t.offset().top, s.paddingTop = parseInt(t.css("padding-top")), o.push(s), t.wrap('<div class="sticky-wrapper"></div>')
                            }), t = !0
                        }();
                        ...
                        i.each(function(i) {
                            ...
                            s + a >= c.offset + c.paddingTop ? (r.hasClass("fixed") || function(t, i, o) {
                                ...
                                }), i.changes && i.changes.forEach(function(e) { e.removeClass && t.find(e.item).removeClass(e.removeClass), e.addClass && t.find(e.item).addClass(e.addClass) }), t.addClass("fixed").css("top", -i.height).animate({ top: o }))
        ...
        headerSearchToggle: function() {
            e(".header-search").length && e("body").on("click", ".header-search", function(e) { e.stopPropagation() }).on("click", ".search-toggle", function(t) {
            ...
            }).on("click", function(t) { e(".header-search").removeClass("show"), e(".header-search-wrapper").removeClass("show"), e("body").removeClass("is-search-active") });
            var t = function() {
        ...
        mMenuToggle: function() { e(".mobile-menu-toggler").on("click", function(t) { e("body").toggleClass("mmenu-active"), e(this).toggleClass("active"), t.preventDefault() }), e(".menu-toggler").on("click", function(t) { e(window).width() >= 992 ? e(".main-dropdown-menu").toggleClass("show") : e("body").toggleClass("mmenu-active"), t.preventDefault() }), e(".mobile-menu-overlay, .mobile-menu-close").on("click", function(t) { e("body").removeClass("mmenu-active"), e(".menu-toggler").removeClass("active"), t.preventDefault() }) },
        mMenuIcons: function() {
        ...
        mobileMenu: function() {
            e(".mmenu-btn").on("click", function(t) {
                var i = e(this).closest("li"),
                    o = i.find("ul").eq(0);
                i.hasClass("open") ? o.slideUp(300, function() { i.removeClass("open") }) : o.slideDown(300, function() { i.addClass("open") }), t.stopPropagation(), t.preventDefault()
            })
        },
        owlCarousels: function() {
            var t = { loop: !0, margin: 0, responsiveClass: !0, nav: !1, navText: ['<i class="icon-angle-left">', '<i class="icon-angle-right">'], dots: !0, autoplay: !0, autoplayTimeout: 15e3, items: 1 },
                ...
                o = {
                    ...
                    ".quantity-inputs": { items: 2, margin: 20, dots: !1, nav: !0, responsive: { 992: { items: 4 }, 768: { items: 3 } }, onInitialized: function() { this.$element.find(".horizontal-quantity").val(1) } },
        ...
        stickySidebar: function() {
            var t = 10;
            e(".header .sticky-header").each(function() { t += e(this).height() }), e(".sidebar-wrapper, .sticky-slider").themeSticky({ autoInit: !0, minWidth: 991, containerSelector: ".row, .container", paddingOffsetBottom: 10, paddingOffsetTop: t })
        },
        countTo: function() {
        ...
        lightBox: function() {
            document.getElementById("newsletter-popup-form") && setTimeout(function() {
                ...
                i.isOpen ? (i.close(), setTimeout(function() { t.newsletterPopup() }, 360)) : t.newsletterPopup()
            }, 1e4);
            var i = [],
            ...
            o.each(function() { i.push({ src: e(this).attr("data-zoom-image") }) }), e(".prod-full-screen").click(function(t) {
                var n;
                n = t.currentTarget.closest(".product-slider-container") ? (e(".product-single-carousel").data("owl.carousel").current() + o.length - Math.ceil(o.length / 2)) % o.length : e(t.currentTarget).closest(".product-item").index(), e.magnificPopup.open({ items: i, navigateByImgClick: !0, type: "image", gallery: { enabled: !0 } }, n)
        ...
        wordRotate: function() { e(".word-rotater").each(function() { e(this).Morphext({ animation: "bounceIn", separator: ",", speed: 2e3 }) }) },
                ...
                o.preventDefault(), e(this).text("Loading ..."), e.ajax({
                    ...
                    success: function(o) {
                        var n = e(".product-ajax-grid"),
                            ...
                            a = e(o);
                        a.find(".product-default").each(function() { e(this).parent().attr("class", s) }), setTimeout(function() { a.hide().appendTo(n).fadeIn(), i.text("Load More"), ++t >= 2 && i.hide() }, 350)
                    },
                    failure: function() { i.text("Sorry something went wrong.") }
                })
            })
        },
        toggleFilter: function() {
            e(".filter-toggle a").click(function(t) { t.preventDefault(), e(".filter-toggle").toggleClass("opened"), e("main").toggleClass("sidebar-opened") }), e(".sidebar-overlay").click(function(t) { e(".filter-toggle").removeClass("opened"), e("main").removeClass("sidebar-opened") }), e(".sort-menu-trigger").click(function(t) { t.preventDefault(), e(".select-custom").removeClass("opened"), e(t.target).closest(".select-custom").toggleClass("opened") }) * / },
            toggleSidebar: function() { e(".sidebar-toggle").click(function() { e("main").toggleClass("sidebar-opened") }) },
                ...
                popupMenu: function() {
                    if (!(e(".popup-menu").length <= 0)) {
                        ...
                        i >= 0 && t.css("margin-right", "-" + i + "px"), t.css("margin-top", i + "px"), e(".popup-menu-toggler").on("click", function(t) { t.preventDefault(), e(this).siblings(".popup-menu").addClass("open"), e(document).on("keydown.popup-menu", function(t) { 27 == t.which && (e(".popup-menu").removeClass("open"), e(document).off("keydown.popup-menu")) }) }), e("body").on("click", ".popup-menu-close", function(t) { e(".popup-menu").removeClass("open"), e(document).off("keydown.popup-menu"), t.preventDefault() }), e("body").on("click", ".popup-menu a", function(t) {
                ...
                topNotice: function() {
                    e(".top-notice .mfp-close").length && e("body").on("click", ".top-notice .mfp-close", function() {
                        e(this).height();
                        e(this).closest(".top-notice").fadeOut(function() { e(this).addClass("closed") })
                    })
                },
                ratingForm: function() {
                ...
                parallax: function() {
                    ...
                    i.length && i.each(function() {
                        ...
                        if (c.css({ "background-image": u, "background-size": "cover", "background-position": "50% 0%", position: "absolute", top: 0, left: 0, width: "100%", height: 100 * l.speed + "%" }), i.prepend(c), i.css({ position: "relative", overflow: "hidden" }), !t.mobile || l.enableOnMobile) {
                            var p = function() { s = i.offset(), a = -(d.scrollTop() - (s.top - 100)) / (l.speed + 2), r = a < 0 ? Math.abs(a) : -Math.abs(a), c.css({ transform: "translate3d(0, " + (r - 50 + l.offset) + "px, 0)", "background-position-x": l.horizontalPosition }) };
                ...
                sideMenu: function() { e(".side-menu").length && e("body").on("click", ".side-menu-toggle", function(t) { e(this).siblings("ul").slideToggle("fast"), e(this).parent().toggleClass("show"), t.stopPropagation() }) }
        };
        e("body").prepend('<div class="loading-overlay"><div class="bounce-loader"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></div>');
        var i = e(".loadmore");
        jQuery(document).ready(function() { t.init() }),
        e(window).on("load", function() { e("body").addClass("loaded"), t.scrollBtnAppear() }),
        e(window).on("scroll", function() { t.scrollBtnAppear() })
    }(jQuery);