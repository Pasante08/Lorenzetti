                ...
                <div class="row row-sm">
                    <div class="col-lg-8">
                        <div class="row row-sm">
                            ...
                            <div class="col-sm-6">
                                <div class="widget">
                                    <h4 class="widget-title">LORENZETTI</h4>

                                    <ul class="links">
                                        <li><a href="?controller=producto&method=getAll">Productos</a></li>
                                        <li><a href="?controller=ayuda&method=ayuda">Preguntas frecuentes</a></li>
                                        <li><a href="?controller=producto&method=services">Servicio Tecnico</a></li>
    ...
    <div class="modal fade" id="addButtonModal" tabindex="-1" role="dialog" aria-labelledby="addCartModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
    <div class="modal-content">
    <div class="modal-body add-cart-box text-center">
    <div class="btn-actions">
