        ...
        <div class="container top-border d-flex align-items-center justify-content-between flex-wrap">
            <div class="footer-left widget-newsletter d-md-flex align-items-center">
                <div class="widget-newsletter-info">
                    <h5 class="widget-newsletter-title text-uppercase m-b-1">suscribase en nuestro boletín</h5>
                    <p class="widget-newsletter-content mb-0">Obtenga toda la información más reciente sobre eventos, ventas y ofertas.</p>
                </div>
                <form action="#">
                    <div class="footer-submit-wrapper d-flex">
                        <input type="email" class="form-control" placeholder="Ingrese su email..." size="40" required>
                        <button type="submit" class="btn btn-dark btn-sm">Subscribirse</button>
                    </div>
                </form>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="contact-widget">
                                    <h4 class="widget-title">DIRECCION</h4>
                                    <a href="#">Cra. 25 N. 13 – 40 Bogotá D.C.</a>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="contact-widget email">
                                    <h4 class="widget-title">EMAIL</h4>
                                    <a href="mailto:fenusa@fenusa.com.co">fenusa@fenusa.com.co</a>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="contact-widget">
                                    <h4 class="widget-title">TELEFONO</h4>
                                    <a href="#">390 6666 EXT 1010</a>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="contact-widget">
                                    <h4 class="widget-title">HORARIOS DE ATENCIÓN</h4>
                                    <a href="#">Lun - Vie / 9:00 AM - 8:00 PM</a>
                                </div>
                            </div>
                        </div>
                    </div>
